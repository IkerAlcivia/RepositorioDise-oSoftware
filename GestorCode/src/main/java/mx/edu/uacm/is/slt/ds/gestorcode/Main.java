    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (comando.equalsIgnoreCase("salir")) {
                ...
                System.out.println("Ingrese nombre de la Operación:");
                String nombreOp = scanner.nextLine();

                Operacion operacion = new Operacion(nombreOp);

                while (true) {
                    System.out.println("Ingrese nombre de la tarea (o 'fin' para terminar esta Operación):");
                    String nombreTarea = scanner.nextLine();
                    if (nombreTarea.equalsIgnoreCase("fin")) break;
                ...
                System.out.println("Operación '" + nombreOp + "' agregada y ejecutándose...");
            } else {
